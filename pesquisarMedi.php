...
<body>
    <aside>
        ...
        <div class="sidebar">
            ...
            <a href="cadastroMedi.php" class="active">
                <span class="material-icons-sharp"></span>
                <h3>Medicamentos</h3>
            </a>
            <a href="inicio.php">
        ...
        <header>
            <div class="navbar">
                ...
                <div class="search-container">
                    <form action="pesquisarMedi.php" method="get">
                        <input type="text" placeholder="Pesquisar Medicamento..." name="pesquisa">
...
if (isset($_GET['pesquisa'])) {
    ...
    $sql = "SELECT * FROM medicamento WHERE nome LIKE '%$pesquisa%'";
    ...
    if (mysqli_num_rows($resultado) > 0) {
        ...
        echo '<div class="modal">
            <div class="modal-content">
                ...
                <p>Não foi encontrado nenhum medicamento com o nome "'.$pesquisa.'".</p>
